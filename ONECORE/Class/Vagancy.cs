...
namespace OneCore.Class
{
    public class Vagancy
    {
                ...
                using (var sqlTransaction = con.BeginTransaction())
                {
                    ...
                    try
                    {
                        ...
                        while (dr.Read())
                        {
                            ...
                            VG_EMAIL = Convert.ToString(dr["VG_EMAIL"]);
                            VG_TELEFONE = Convert.ToString(dr["VG_TELEFONE"]);
                            VG_NAMECOMPANY = Convert.ToString(dr["VG_NAMECOMPANY"]);
                        }
        ...
        public void Add(Transaction ltransaction = null)
        {
            using (var con = ltransaction.Connection())
            {
                ...
                using (var sqlTransaction = con.BeginTransaction())
                {
                    ...
                    try
                    {
                        cmd.CommandText = " INSERT INTO VAGANCY VALUES (@VG_TITLE,@CPY_ID,@VG_DATE_FINALLY,@VG_OBS,@VG_STATUS,@VG_DATECREATE,@VG_VALUE,@USS_ID,@VG_EMAIL,@VG_TELEFONE,@VG_NAMECOMPANY)";
                        ...
                        cmd.Parameters.Add(new SqlParameter("@VG_EMAIL", Convert.ToString(this.VG_EMAIL)));
                        cmd.Parameters.Add(new SqlParameter("@VG_TELEFONE", Convert.ToString(this.VG_TELEFONE)));
                        cmd.Parameters.Add(new SqlParameter("@VG_NAMECOMPANY", Convert.ToString(this.VG_NAMECOMPANY)));
                        cmd.ExecuteNonQuery();
        ...
        public void Update(decimal pVAGANCY_ID,  Transaction ltransaction = null)
        {
            using (var con = ltransaction.Connection())
            {
                ...
                using (var sqlTransaction = con.BeginTransaction())
                {
                    ...
                    try
                    {
                        cmd.CommandText = $" UPDATE VAGANCY SET VG_TITLE = @VG_TITLE, VG_DATE_FINALLY= @VG_DATE_FINALLY, VG_OBS = @VG_OBS, VG_STATUS= @VG_STATUS,VG_VALUE=@VG_VALUE, VG_EMAIL= @VG_EMAIL,VG_TELEFONE=@VG_TELEFONE,VG_NAMECOMPANY =@VG_NAMECOMPANY  WHERE VAGANCY_ID = {pVAGANCY_ID}";
        ...
        public string VG_EMAIL { get; set; }
        public string VG_TELEFONE { get; set; }
        public string VG_NAMECOMPANY { get; set; }
