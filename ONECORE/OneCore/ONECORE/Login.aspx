...
<body id="body" style="background-image: url(img/imageBody.jpg);">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <asp:Button ID="btnEntrar" ValidationGroup="Add" OnClick="btnEntrar_Click" Text="Entrar" class=" btn-block btn-success mr-2" runat="server" />
